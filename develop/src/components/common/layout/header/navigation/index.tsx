...
export default function Navigation(): JSX.Element {
    ...
    return (
        <>
            <A.NavigationWrap>
                <A.MenuWrap>
                    <A.NavigationButton isActive={true} onClick={() => toggleMenu('first')}>
                        경기지역화폐
                    </A.NavigationButton>
                    <A.SubMenuWrap isopen={menuState.first}>
                        {FirstsubMenu.map((el) => (
                            <A.subMenuList onClick={onClickMenu} id={el.src} key={el.name}>
                                {el.name}
                            </A.subMenuList>
                        ))}
                    </A.SubMenuWrap>
                ...
                <A.MenuWrap>
                    <A.NavigationButton isActive={false} onClick={() => toggleMenu('second')}>
                        가맹점이용안내
                    </A.NavigationButton>
                ...
                <A.MenuWrap>
                    <A.NavigationButton isActive={true} onClick={() => toggleMenu('third')}>
                        우리동네가맹점
                    </A.NavigationButton>
